...
export default function SponsorsPage({
  ...
  const handleSponsorSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${baseUrl}/api/sponsor-apply`, {
        method: 'POST',
    ...
    <section className="content-section" id="sponsors">
      ...
      <div className="sponsorship-prospectus">
        ...
        <div className="prospectus-brochure-cta">
          <a
            href="https://drive.google.com/uc?export=download&id=1NUe-52WTSNoywgjmGY0sYwGlQXl2ip6Y"
            className="btn btn-primary prospectus-download-btn"
          >

...
import { Target, Users, Check, Trophy, Medal, Star, ClipboardList, Calendar, Rocket, X, ArrowRight, Edit2, Trash2, Plus, HelpCircle, Gavel } from 'lucide-react'
...
const HACKATHON_JUDGES = [
  {
    id: 'rohan-rajpal',
    name: 'Rohan Rajpal',
    title: 'Co-Founder & CTO @ Spurtastic Technologies',
    bio: 'Co-Founder and CTO @ Spurtastic Technologies, with experience in architecting AI systems and messaging infrastructure at scale.',
  ...
  },
  {
    ...
    bio: 'Co-Founder and CEO @ Spurtastic Technologies, with a track record of building and scaling a bootstrapped, profitable AI product company.',
  ...
  },
  {
    ...
    title: 'Chief AI Officer @ Siftly AI',
    bio: 'Chief AI Officer @ Siftly AI with expertise in building and scaling AI-driven SaaS products.',
    linkedin: 'https://www.linkedin.com/in/mrvaibhav98/',
    photoURL: 'https://media.licdn.com/dms/image/v2/D4D03AQFcDztwjt4fxA/profile-displayphoto-shrink_800_800/profile-displayphoto-shrink_800_800/0/1666251867989?e=1789603200&v=beta&t=pQzkGquaAehQFK3aLdWCO8_2B2XzPrfCGOrECgkSxRI'
  }
]
    ...
    <div className="hackathon-body" id="hackathon">
      ...
      {siteConfig.hackathonHidden === 'true' && !adminMode ? (
        ...
        <div className="hackathon-content-container">
          ...
          {/* ── HACKATHON JUDGES ── */}
          <section className="hk-card hk-section-judges">
            <div className="hk-card-header">
              <div className="hk-title-group">
                <div className="hk-icon"><Gavel size={22} color="var(--color-brand-blue)" /></div>
                <h2 className="hk-section-heading">Hackathon Judges</h2>
              </div>
            </div>

            <div className="hk-judges-grid">
              {HACKATHON_JUDGES.map((judge) => (
                <div key={judge.id} className="hk-judge-card">
                  <div className="hk-judge-avatar-wrap">
                    <img
                      src={judge.photoURL || ''}
                      alt={judge.name}
                      loading="lazy"
                      onError={(e) => {
                        ...
                        e.currentTarget.src = "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3E%3Crect width='100' height='100' fill='%231e293b'/%3E%3Ccircle cx='50' cy='38' r='20' fill='%230ea5e9' opacity='0.5'/%3E%3Cellipse cx='50' cy='85' rx='32' ry='22' fill='%230ea5e9' opacity='0.3'/%3E%3C/svg%3E";
                      }}
                    />
                  </div>
                  <div className="hk-judge-info">
                    <h3 className="hk-judge-name">{judge.name}</h3>
                    <span className="hk-judge-title-badge">{judge.title}</span>
                    <p className="hk-judge-bio">{judge.bio}</p>
                    {judge.linkedin && (
                      <a
                        href={judge.linkedin}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hk-judge-linkedin-btn"

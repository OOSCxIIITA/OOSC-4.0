...
function App() {
  ...
  const modalFieldMap = {
    speakers: [
      { key: 'name', label: 'Name', type: 'text', placeholder: 'e.g. Linus Torvalds' },
      { key: 'title', label: 'Title / Affiliation', type: 'text', placeholder: 'e.g. Creator of Linux' },
      { key: 'bio', label: 'Biography', type: 'textarea', placeholder: 'e.g. Linus Benedict Torvalds is a Finnish-American software engineer...' },
      { key: 'photoURL', label: 'Photo URL / Upload Link', type: 'text', placeholder: 'e.g. https://example.com/photo.jpg' },
      { key: 'linkedin', label: 'LinkedIn URL', type: 'text', placeholder: 'e.g. https://linkedin.com/in/username' },
      { key: 'github', label: 'GitHub URL', type: 'text', placeholder: 'e.g. https://github.com/torvalds' },
      { key: 'sortOrder', label: 'Sort Order', type: 'number', placeholder: 'e.g. 1' },
    ],
    sponsors: [
      { key: 'name', label: 'Sponsor Name', type: 'text', placeholder: 'e.g. GitHub' },
      { key: 'category', label: 'Category', type: 'select', options: sponsorCategories },
      { key: 'website', label: 'Website URL', type: 'text', placeholder: 'e.g. https://github.com' },
      { key: 'logoURL', label: 'Logo URL / Upload Link', type: 'text', placeholder: 'e.g. https://example.com/logo.png' },
      { key: 'sortOrder', label: 'Sort Order', type: 'number', placeholder: 'e.g. 1' },
    ],
    events: [
      { key: 'title', label: 'Session Title', type: 'text', placeholder: 'e.g. Opening Keynote' },
      { key: 'description', label: 'Description', type: 'textarea', placeholder: 'e.g. Join us for the opening remarks.' },
      { key: 'date', label: 'Date', type: 'text', placeholder: 'e.g. Aug 28' },
      { key: 'time', label: 'Time', type: 'text', placeholder: 'e.g. 10:00 AM - 11:00 AM' },
      { key: 'type', label: 'Type', type: 'text', placeholder: 'e.g. Keynote, Workshop, Panel' },
      { key: 'sortOrder', label: 'Sort Order', type: 'number', placeholder: 'e.g. 1' },
    ],
    team: [
      { key: 'name', label: 'Name', type: 'text', placeholder: 'e.g. Alice Smith' },
      { key: 'role', label: 'Role / Title', type: 'text', placeholder: 'e.g. Lead Organizer' },
      { key: 'department', label: 'Team Category', type: 'select', options: teamCategories },
      { key: 'contact', label: 'Contact Email / Phone', type: 'text', placeholder: 'e.g. alice@example.com' },
      { key: 'linkedin', label: 'LinkedIn Profile URL', type: 'text', placeholder: 'e.g. https://linkedin.com/in/alice' },
      { key: 'instagram', label: 'Instagram Profile URL', type: 'text', placeholder: 'e.g. https://instagram.com/alice' },
      { key: 'photoURL', label: 'Photo URL / Upload Link', type: 'text', placeholder: 'e.g. https://example.com/photo.jpg' },
      { key: 'sortOrder', label: 'Sort Order', type: 'number', placeholder: 'e.g. 1' },
    ],
    'registration-cards': [
      { key: 'title', label: 'Card Title', type: 'text', placeholder: 'e.g. Hacker Pass' },
      { key: 'price', label: 'Price', type: 'text', placeholder: 'e.g. Free' },
      { key: 'description', label: 'Description', type: 'textarea', placeholder: 'e.g. Full access to the hackathon.' },
      { key: 'features', label: 'Features (one per line)', type: 'textarea', placeholder: 'e.g. 3-Day Entry\\nFree Meals\\nSwag Bag' },
      { key: 'icon', label: 'Lucide Icon Name', type: 'select', options: ['Ticket', 'Zap', 'Shield', 'Check', 'User', 'Users', 'Star'] },
      { key: 'type', label: 'Card Type', type: 'select', options: ['normal', 'featured'] },
      { key: 'sortOrder', label: 'Sort Order', type: 'number', placeholder: 'e.g. 1' },
    ],
    'info-cards': [
      { key: 'title', label: 'Card Title', type: 'text', placeholder: 'e.g. Important Dates' },
      { key: 'content', label: 'HTML Content', type: 'textarea', placeholder: 'e.g. <p>Registration closes on Aug 20.</p>' },
      { key: 'sortOrder', label: 'Sort Order', type: 'number', placeholder: 'e.g. 1' },
    ],
    'hackathon-tracks': [
  ...
  const getDefaultModalData = (resource) => {
    const defaults = {
      ...
      team: { name: '', role: '', department: 'Student Coordinators', contact: '', linkedin: '', instagram: '', photoURL: uploadUrl || '', sortOrder: team.length + 1, published: true },
